...
require (
	...
	github.com/creachadair/mds v0.30.3 // indirect
...
replace github.com/akmalfairuz/legacy-version => github.com/gameparrot/legacy-version-no-mapping v1.5.5-0.20260716225800-be0f198f71b3
