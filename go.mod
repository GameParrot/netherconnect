...
require (
	...
	github.com/bedrock-tool/bedrocktool v1.48.0
...
replace github.com/akmalfairuz/legacy-version => github.com/gameparrot/legacy-version-no-mapping v1.5.5-0.20250714005527-b8854f3f0455
